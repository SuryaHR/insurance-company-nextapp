const translate = {
  ...
  errorMsg: {
    ...
    newPassword: {
      ...
      samePasswordError: "New password should be different from current password",
    },
    confirmPass: {
      requireError: "Please retype your new password.",
      compareError: "New Password and confirm password does not match.",
    },
  },
};
