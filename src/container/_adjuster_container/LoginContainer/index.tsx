...
import LoginComponent from "@/components/_adjuster_components/LoginComponent";
...
async function LoginContainer({ translate }: { translate: loginTranslatePropType }) {
    ...
    <div className={loginContainerStyle.loginContainer}>
      ...
      <div className={clsx(loginContainerStyle.loginContainer__main, "container")}>
        ...
        >
          <LoginComponent
            translate={translate}
            heading={data?.attachments[0]?.description}
          />
        </div>
      </div>
