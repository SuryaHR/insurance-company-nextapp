...
import selectItemUID from "@/reducers/_core_logic_reducers/LineItemDetail/Selectors/selectItemUID";
import { addCustomItem } from "@/services/_core_logic_services/CoreLineItemDetailService";
import { fetchLineItemDetail } from "@/reducers/_core_logic_reducers/LineItemDetail/LineItemThunkService";
...
import selectItemTaxDetail from "@/reducers/_core_logic_reducers/LineItemDetail/Selectors/selectItemTaxDetail";
import selectItemQuantity from "@/reducers/_core_logic_reducers/LineItemDetail/Selectors/selectItemQuantity";
...
function CustomComparable({
  ...
  const createComparable = async (
    ...
    try {
      const res = await addCustomItem(param, token);
      if (res?.status !== 200) {
        return dispatch(
          addNotification({
...
const mapStateToProps = (state: any) => ({
  CompanyCRN: selectCRN(state),
});
export default connect(mapStateToProps, null)(CustomComparable);
