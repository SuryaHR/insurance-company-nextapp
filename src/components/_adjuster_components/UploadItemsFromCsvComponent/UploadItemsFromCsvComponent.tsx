...
import { fetchExcelCsvTableData } from "@/services/_adjuster_services/ClaimService";
...
const UploadItemsFromCsvComponent: React.FC<connectorType> = (props) => {
  ...
  const handleFinishUpload = async () => {
    ...
    if (isFileUploaded && excelData) {
      ...
      const applyTax = sessionStorage.getItem("applyTax");
      const payload = { claimNumber, postlossItems: postLossItemDetails, applyTax };
