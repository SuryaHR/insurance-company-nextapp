...
import { addNewRoom } from "@/services/_adjuster_services/AddItemContentService";
...
import {
  ...
  getNextItem,
  updateContentItem,
} from "@/services/_adjuster_services/AddItemContentService";
                ...
                <Controller
                  ...
                  render={({ field: { onChange } }) => (
                    <GenericCurrencyFormat
                      inputFieldClassname={addClaimFormStyle.customInput}
                      placeholder={
                        translate?.addItemModalTranslate?.inputFields?.price?.placeholder
                      }
