...
import { uploadActivityLogData } from "@/services/_adjuster_services/AdjusterPropertyClaimDetailServices/AdjusterPropertyClaimDetailService";
        ...
        <div className={clsx(modalStyle.upperContainer, "p-2 row")}>
          <div className="col-4">
            ...
            <div className={modalStyle.infoTextbox}>
              <span>
                {
                  translate?.adjusterPropertyClaimActivityLog?.activitylog
                    ?.addActivityPopup?.helpText
                }
              </span>
            </div>
          </div>
          <div className={clsx(modalStyle.descCont, "col-8")}>
            ...
            <div style={{ height: "22px" }}>
              ...
              >
                {
                  translate?.adjusterPropertyClaimActivityLog?.activitylog
                    ?.addActivityPopup?.inputField?.error
                }
              </span>
            </div>
          </div>
