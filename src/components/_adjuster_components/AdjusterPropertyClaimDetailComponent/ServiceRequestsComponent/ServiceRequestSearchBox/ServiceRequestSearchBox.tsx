...
import { fetchServiceRequestList } from "@/services/_adjuster_services/ClaimServiceRequestListService";
import { addServiceSearchKeyWord } from "@/reducers/_adjuster_reducers/ClaimData/ClaimServiceRequestSlice";
...
const ServiceRequestSearchBox: React.FC<connectorType & typeProps> = (props) => {
  ...
  return (
    <div className={ServiceRequestSearchStyle.searchBox}>
      ...
      <input
        type="text"
        placeholder={translate?.serviceRequestTranslate?.search ?? ""}
        value={searchValue}
